    ...
    missionTemplates: {
        daily: [
            ...
            },
            {
                id: 'dungeon_clear',
                type: 'dungeon',
                name: 'District Cleaner',
                description: 'Complete 3 dungeon runs',
                objectives: [
                    { type: 'complete_dungeons', count: 3 }
                ],
                rewards: {
                    copper: 2000,
                    silver: 5,
        ...
        weekly: [
            {
                ...
                rewards: {
                    gold: 1,
                    items: [
                        { id: 'rare_gacha_ticket', quantity: 1 }
                    ]
                }
            }
        ]
